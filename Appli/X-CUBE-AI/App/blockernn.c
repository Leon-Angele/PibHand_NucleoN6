 ...
 * --load-mdesc-file = "C:/Users/leon.angele/STM32Cube/Repository/Packs/STMicroelectronics/X-CUBE-AI/10.2.0/scripts/N6_scripts/my_mdescs/stm32n6"
 * --load-mpool-file = "C:/Users/leon.angele/STM32Cube/Repository/Packs/STMicroelectronics/X-CUBE-AI/10.2.0/scripts/N6_scripts/my_mpools/stm32n6"
 * --cache-maintenance = true
 * --enable-virtual-mem-pools = true
 * --native-float = true
 * --json-quant-file = "C:/Users/leon.angele/.stm32cubemx/blockernn_output/sin_model_OE_3_3_0_Q.json"
 * --optimization = 3
 * --Os = true
 * --Omax-ca-pipe = 4
 * --Ocache-opt = true
 * --output-info-file = "c_info"
 * --onnx-input = "C:/Users/leon.angele/.stm32cubemx/blockernn_output/sin_model_OE_3_3_0.onnx"
 * --out-dir-prefix = "C:/Users/leon.angele/AppData/Local/Temp/mxAI_workspace21639315846400018256978929412992897/neural_art__blockernn/"
 * --network-name = "blockernn"
...
LL_ATON_User_IO_Result_t LL_ATON_Set_User_Input_Buffer_blockernn(uint32_t num, void* buffer, uint32_t size)
{
  { 
...
void *LL_ATON_Get_User_Input_Buffer_blockernn(uint32_t num)
{
  { 
    return NULL;
  }
...
LL_ATON_User_IO_Result_t LL_ATON_Set_User_Output_Buffer_blockernn(uint32_t num, void* buffer, uint32_t size)
{
  { 
    return LL_ATON_User_IO_WRONG_INDEX;
  }
...
void *LL_ATON_Get_User_Output_Buffer_blockernn(uint32_t num)
{
  { 
    return NULL;
  }
...
bool LL_ATON_EC_Network_Init_blockernn(void)
{
  return true;
}

bool LL_ATON_EC_Inference_Init_blockernn(void)
{
  return true;
}
...
/* kind=Conv node=Gemm_1_conv_4 */
  Conv_sw_info conv1_sw_info = {
    ...
    .weights.dim.num_elem = 30,
    .weights.stride.b = 4,
    .weights.stride.h = 4,
    .weights.stride.w = 4,
    .weights.stride.c = 4,
    .weights.mem.start_offset = ((unsigned char *)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x71000000UL + 5120))) /* Equivalent hex address = 0x71001400UL */,
...
/* kind=Add node=Gemm_1_add_6 */
  Arith_sw_info arith2_sw_info = {
    ...
    .operand.dim.tensor_w = 30,
    .operand.dim.tensor_c = 1,
    .operand.dim.num_elem = 30,
    .operand.stride.b = 120,
    .operand.stride.h = 120,
    .operand.stride.w = 4,
    .operand.stride.c = 4,
    .operand.mem.start_offset = ((unsigned char *)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x71000000UL + 5248))) /* Equivalent hex address = 0x71001480UL */,
...
/* kind=Sigmoid node=Sigmoid_2 */
  ...
  /* Low Level SW Layer function invocation. This will exploit EmbedNets libs) */
  /* Node Sigmoid_2 mapped on EmbedNets (FLOAT) as Sigmoid | Category: Computational */
...
/* kind=Conv node=Gemm_3_conv_11 */
  Conv_sw_info conv4_sw_info = {
    ...
    .general.input.stride.b = 120,
    .general.input.stride.h = 120,
    .general.input.stride.w = 120,
    .general.input.stride.c = 4,
    .general.input.mem.start_offset = ((unsigned char *)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x342e0000UL + 160))) /* Equivalent hex address = 0x342e00a0UL */,
    .general.input.format.is_signed = 0,
    /* "weights" tensor-related info: */
    .weights.dim.tensor_b = 40,
    .weights.dim.tensor_h = 1,
    .weights.dim.tensor_w = 1,
    .weights.dim.tensor_c = 30,
    .weights.dim.num_elem = 1200,
    .weights.stride.b = 120,
    .weights.stride.h = 120,
    .weights.stride.w = 120,
    .weights.stride.c = 4,
    ...
    .general.output.dim.tensor_h = 1,
    .general.output.dim.tensor_w = 1,
    .general.output.dim.tensor_c = 40,
    .general.output.dim.num_elem = 40,
    .general.output.stride.b = 160,
    .general.output.stride.h = 160,
    .general.output.stride.w = 160,
    .general.output.stride.c = 4,
...
/* kind=Add node=Gemm_3_add_13 */
  Arith_sw_info arith5_sw_info = {
    ...
    .general.input.dim.tensor_c = 1,
    .general.input.dim.num_elem = 40,
    .general.input.stride.b = 160,
    ...
    .operand.dim.tensor_c = 1,
    .operand.dim.num_elem = 40,
    .operand.stride.b = 160,
    .operand.stride.h = 160,
    .operand.stride.w = 4,
    .operand.stride.c = 4,
    .operand.mem.start_offset = ((unsigned char *)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x71000000UL + 4960))) /* Equivalent hex address = 0x71001360UL */,
    .operand.format.is_signed = 0,
    /* "general.output" tensor-related info: */
    .general.output.dim.tensor_b = 1,
    .general.output.dim.tensor_h = 1,
  ...
  LL_ATON_Cache_MCU_Clean_Range(((uintptr_t)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x342e0000UL + 160))) /* Equivalent hex address = 0x342e00a0UL */, 160);
...
/* Unit= 27 [PROCESSOR 0] */
/* kind=Sigmoid node=Sigmoid_4 */
  Activ_sw_info activ6_sw_info = {
    /* "general.input" tensor-related info: */
    .general.input.dim.tensor_b = 1,
    .general.input.dim.tensor_h = 1,
    .general.input.dim.tensor_w = 1,
    .general.input.dim.tensor_c = 40,
    .general.input.dim.num_elem = 40,
    .general.input.stride.b = 160,
    .general.input.stride.h = 160,
    .general.input.stride.w = 4,
  ...
  /* Low Level SW Layer function invocation. This will exploit EmbedNets libs) */
  /* Node Sigmoid_4 mapped on EmbedNets (FLOAT) as Sigmoid | Category: Computational */
...
/* kind=Conv node=Gemm_5_conv_18 */
  Conv_sw_info conv7_sw_info = {
    ...
    .weights.dim.tensor_h = 1,
    .weights.dim.tensor_w = 1,
    .weights.dim.tensor_c = 40,
    .weights.dim.num_elem = 40,
    .weights.stride.b = 160,
    .weights.stride.h = 160,
    .weights.stride.w = 160,
    .weights.stride.c = 4,
    .weights.mem.start_offset = ((unsigned char *)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x71000000UL + 4800))) /* Equivalent hex address = 0x710012c0UL */,
    .weights.format.is_signed = 0,
    /* "general.output" tensor-related info: */
    .general.output.dim.tensor_b = 1,
    .general.output.dim.tensor_h = 1,
...
/* kind=Add node=Gemm_5_add_20 */
  Arith_sw_info arith8_sw_info = {
    ...
    .operand.stride.w = 4,
    .operand.stride.c = 4,
    .operand.mem.start_offset = ((unsigned char *)(ATON_LIB_PHYSICAL_TO_VIRTUAL_ADDR(0x71000000UL + 5376))) /* Equivalent hex address = 0x71001500UL */,
    .operand.format.is_signed = 0,
    /* "general.output" tensor-related info: */
    .general.output.dim.tensor_b = 1,
    .general.output.dim.tensor_h = 1,
...
const EpochBlock_ItemTypeDef *LL_ATON_EpochBlockItems_blockernn(void) {
...
const LL_Buffer_InfoTypeDef *LL_ATON_Input_Buffers_Info_blockernn(void)
{
  ...
  static const uint32_t buff_info__shape_40[] = { 1, 1, 40, 1 };
  static const uint32_t buff_info__mem_shape_U_40[] = { 40 };
  static const uint32_t buff_info__shape_1[] = { 1, 1, 1, 1 };
  static const uint32_t buff_info__mem_shape_U_1[] = { 1 };
  static const uint32_t buff_info__shape_30_1_1_1[] = { 30, 1, 1, 1 };
  static const uint32_t buff_info__mem_shape_F_30_1_1_1[] = { 30, 1, 1, 1 };
  static const uint32_t buff_info__shape_40_30_1_1[] = { 40, 1, 1, 30 };
  static const uint32_t buff_info__mem_shape_F_40_30_1_1[] = { 40, 30, 1, 1 };
  static const uint32_t buff_info__shape_1_40_1_1[] = { 1, 1, 1, 40 };
  static const uint32_t buff_info__mem_shape_F_1_40_1_1[] = { 1, 40, 1, 1 };
  ...
  static const LL_Buffer_InfoTypeDef buff_info[] = {
    ...
    },
    {
      ...
      .epoch = 0,
      .batch = 1,
      .mem_shape = buff_info__mem_shape_U_40,
      .mem_ndims = 1,
      .chpos = CHPos_UNDEFINED,
      .Qm = 0,
      .Qn = 0,
    ...
    },
    {
      ...
      .epoch = 0,
      .batch = 1,
      .mem_shape = buff_info__mem_shape_F_30_1_1_1,
      .mem_ndims = 4,
      .chpos = CHPos_First,
      .Qm = 0,
      .Qn = 0,
      ...
      .nbits = 32,
      .ndims = 4,
      .shape = buff_info__shape_30_1_1_1,
    },
    {
      ...
      .epoch = 0,
      .batch = 30,
      .mem_shape = buff_info__mem_shape_F_40_30_1_1,
      .mem_ndims = 4,
      .chpos = CHPos_First,
      .Qm = 0,
      .Qn = 0,
      ...
      .nbits = 32,
      .ndims = 4,
      .shape = buff_info__shape_40_30_1_1,
    },
    {
      ...
      .epoch = 0,
      .batch = 40,
      .mem_shape = buff_info__mem_shape_F_1_40_1_1,
      .mem_ndims = 4,
      .chpos = CHPos_First,
      .Qm = 0,
      .Qn = 0,
      ...
      .nbits = 32,
      .ndims = 4,
      .shape = buff_info__shape_1_40_1_1,
    },
#endif // LL_ATON_DBG_BUFFER_INFO_EXCLUDED == 0
    {
      .name = NULL,
...
const LL_Buffer_InfoTypeDef *LL_ATON_Output_Buffers_Info_blockernn(void)
{
  static const uint32_t buff_info__shape_1_1[] = { 1, 1, 1, 1 };
  static const uint32_t buff_info__mem_shape_U_1_1[] = { 1, 1 };
  static const LL_Buffer_InfoTypeDef buff_info[] = {
...
const LL_Buffer_InfoTypeDef *LL_ATON_Internal_Buffers_Info_blockernn(void)
{
  static const uint32_t buff_info__shape_1_1_1_1[] = { 1, 1, 1, 1 };
  static const uint32_t buff_info__mem_shape_F_1_1_1_1[] = { 1, 1, 1, 1 };
  static const uint32_t buff_info__shape_1_30_1_1[] = { 1, 1, 1, 30 };
  static const uint32_t buff_info__mem_shape_F_1_30_1_1[] = { 1, 30, 1, 1 };
  static const uint32_t buff_info__shape_1_30[] = { 1, 1, 30, 1 };
  static const uint32_t buff_info__mem_shape_U_1_30[] = { 1, 30 };
  static const uint32_t buff_info__shape_1_40_1_1[] = { 1, 1, 1, 40 };
  static const uint32_t buff_info__mem_shape_F_1_40_1_1[] = { 1, 40, 1, 1 };
  ...
  static const LL_Buffer_InfoTypeDef buff_info[] = {
    ...
    },
    {
      ...
      .epoch = 2,
      .batch = 30,
      .mem_shape = buff_info__mem_shape_F_1_30_1_1,
      .mem_ndims = 4,
      .chpos = CHPos_First,
      .Qm = 0,
      .Qn = 0,
      ...
      .nbits = 32,
      .ndims = 4,
      .shape = buff_info__shape_1_30_1_1,
    },
    {
      ...
      .epoch = 3,
      .batch = 1,
      .mem_shape = buff_info__mem_shape_U_1_30,
      .mem_ndims = 2,
      .chpos = CHPos_UNDEFINED,
      .Qm = 0,
      .Qn = 0,
